...
//  $category = get_query_var("tag")?get_query_var("tag"):"";
?>
            ...
            <div id="scrollbar" class="art-scroll-frame">
              ...
              <div class="container-fluid" style="min-height: 69vh;">
                ...
                <div class="row p-30-0">
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="art-section-title">
                      ...
                      <div class="art-title-frame">
                        <!-- title -->
                        <h4><?php printf( __( '%s', 'nakagawa' ),  single_tag_title( '', false ) );?></h4>
                      </div>
                      <!-- title frame end -->
                    </div>
                    <!-- section title end -->
                  ...
                  <!-- col end -->
                  <?php
                    // $wpb_all_query = new WP_Query(array('post_type'=>'post', 'post_status'=>'publish', 'posts_per_page'=>9, 'paged'=> $paged, 'tag'=> $tag));
                    // $wpb_all_query = new WP_Query(array('post_type'=>'post', 'post_status'=>'publish', 'posts_per_page'=>9, 'paged'=> $paged));
