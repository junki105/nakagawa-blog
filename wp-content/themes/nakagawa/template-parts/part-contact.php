      ...
      <div class="art-a art-card">
        <div class="art-table p-15-15">
          <ul>
            ...
            <li>
              <h6>Streat:</h6><span>3-8-4-301 Meguro-ku</span>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="col-lg-4">
      ...
      <div class="art-a art-card">
        <div class="art-table p-15-15">
          <ul>
            <li>
              <h6>Chatwork:</h6><span>junki1005</span>
            </li>
            <li>
              <h6>Skype:</h6><span>live:.cid.1ecb380f1f34d0f3</span>
            </li>
            <li>
              <h6>Personal:</h6><span>+1 717 673 8940</span>
            </li>
          </ul>
        </div>
      </div>
